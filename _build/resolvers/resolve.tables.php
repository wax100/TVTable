...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('tvtable_core_path', null,
                    $modx->getOption('core_path') . 'components/tvtable/') . 'model/';
            $modx->addPackage('tvtable', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/tvtable/model/schema/tvtable.mysql.schema.xml';
